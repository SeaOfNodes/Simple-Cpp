...
//    std::strint r = e.what();
//    EXCEPT_EQ(r, "Syntax error, expected =expression:")
//}}
//
//
...
//std::ostringstream builder;
//std::string result = ret->print(builder).str();
//EXPECT_EQ(result, "return Phi(Region,1,2);");
//}
//
//
...
//std::ostringstream builder;
//std::string result = ret->print(builder).str();
//EXPECT_EQ(result, "return Phi(Region,1,-1);");
//}
//
//
...
//std::ostringstream builder;
//std::string result = ret->print(builder).str();
//EXPECT_EQ(result, "return Phi(Region,1.0,1.2);");
//}
//
//
//// ---------------------------------------------------------------
...
//std::ostringstream builder;
//std::string result = ret->print(builder).str();
//EXPECT_EQ(result, "return Phi(Loop,0,(Phi_sum+Phi(Loop,0,(Phi_i+1))));");
//}
//
//
...
//} catch(std::runtime_error &e) {
//std::string r = e.what();
//EXPECT_EQ(r, "Syntax error, expected Unexpected code after expression: ;");
//}
//}
//
//// ---------------------------------------------------------------
...
//std::ostringstream builder;
//std::string result = ret->print(builder).str();
//EXPECT_EQ(result, "return Phi(Loop,0,(Phi_sum+.i));");
//}
